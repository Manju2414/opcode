...
export const ClaudeCodeSession: React.FC<ClaudeCodeSessionProps> = ({
  ...
  const [queuedPrompts, setQueuedPrompts] = useState<Array<{ id: string; prompt: string; model: ModelId }>>([]);
  ...
  const queuedPromptsRef = useRef<Array<{ id: string; prompt: string; model: ModelId }>>([]);
  ...
  const handleSendPrompt = async (prompt: string, model: ModelId) => {
